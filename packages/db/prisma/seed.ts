...
async function main() {
    ...
    await prisma.profiles.createMany({
        data: [
            ...
            { email: 'miranda.green@myworkdoc.com', cell_number: '214-405-0003', company_id: 10, first_name: 'Miranda', last_name: 'Green', active: true, ein: '123456711', profile_type_id: 3 },
