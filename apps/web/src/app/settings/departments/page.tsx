...
export default function DepartmentsGrid() {
    ...
    const { data: count } = api.departments.count.useQuery(gridState);
    const { data, isLoading } = api.departments.grid.useQuery(gridState);
    ...
    return (
        <div className="h-full w-full">
            ...
            <div className="flex justify-between  h-17 p-4 bg-gray-50 border-b-2 border-gray-300 ">
                ...
                <h3 className="text-2xl font-semibold leading-6 text-gray-900">Departments</h3>
