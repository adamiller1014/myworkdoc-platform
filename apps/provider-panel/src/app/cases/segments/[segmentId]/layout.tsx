                            ...
                            <Link
                                ...
                                <div className={classNames(isActive && "border-l-2 border-blue-500 bg-blue-100", "p-3 space-y-4")}>
                                    <div className="flex flex-row items-center space-x-2">
                                        ...
                                        <strong className="flex-grow text-sm">{item.profile.first_name} {item.profile.last_name}</strong>
                                    ...
                                    <div className="flex flex-row items-center space-x-1">
                                        ...
                                        <div className="flex-grow truncate text-xs">{item.case_types?.name} </div>
                                    </div>
                                </div>
                            </Link>
                        </>
